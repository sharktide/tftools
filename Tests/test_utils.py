...
class TestHFUtils(unittest.TestCase):
    ...
    def test_download_model_from_huggingface_default_filename(self):
        ...
        model_path = download_model_from_huggingface(self.model_id)
        ...
        model = load_model_from_cache(model_path.name)
    ...
    def test_cache_directory_exists(self):
        ...
        download_model_from_huggingface(self.model_id)
        self.assertTrue(self.cache_dir.exists())

    def test_invalid_model_path(self):
        """Test loading an invalid model path."""
        with self.assertRaises(FileNotFoundError):
            load_model_from_cache("invalid_model_name.h5")
